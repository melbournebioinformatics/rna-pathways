...
You can directly download the file that we will be using from [this link](episodes/data/BrowseTF_TcoF-DB.csv).
...
<img src="fig/05regenrich-rendered-unnamed-chunk-4-1.png" alt="" style="display: block; margin: auto;" />
